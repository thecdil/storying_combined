...
{% include feature/quote.md text="If there is only crumbs left—lick them up." objectid="" source="Note found inside a package of homemade biscotti from Grandma Pat."%}
