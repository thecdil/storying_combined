...
{% include feature/marginnote.html id="dev" text="First known photograph of Upper Priest Lake from *The Diary of our Trip to E-Soc-Quet by One of the Party* (1887). [Shedroof Mountain]({{ '/mountains/tosleep.html#gargoyle' | relative_url}}) and the future South Selkirk caribou critical habitat loom in the distant background." %}
