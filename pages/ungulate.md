...
Dave tells the story of how for ten years he tried and failed to see a black caribou in the wild. I will not relate his story here because it is too long, but also because the timbre and eloquence of Dave's voice, like Bob's, deserves to be heard rather than read—and can be heard, on our [deep map]({{ '/map.html' | relative_url }}). Suffice to say: A decade of going up and down the gnashing serrated teeth of the Selkirk crest on snowshoes. But to no avail. He saw tracks but never the ghost itself. Chris asks him what he thinks it would have been like to see a caribou. Dave smiles.
